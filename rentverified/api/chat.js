...
export default async function handler(req, res) {
  ...
  const propertyContext = body.propertyContext || 'General 3120 Life / [Your Business Name] inquiry.';
  const system = `You are the friendly AI assistant for [Your Business Name] on 3120 Life. Answer briefly and helpfully about rentals, applications, tours, and this property. Do not make up rent or addresses; use only the context below. If you don't know, suggest they request an application or contact management.
